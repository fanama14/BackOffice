...
-- ================================================================
-- Sprint 5 - 11/03/2026
-- Modification de la règle du temps d'attente pour le regroupement
-- ================================================================
-- Nouvelle règle de regroupement par fenêtre glissante :
...
-- Toutes les réservations dont l'heure d'arrivée tombe dans cette fenêtre
-- sont regroupées ensemble (sous réserve des autres contraintes : capacité, etc.)
-- La fenêtre suivante commence à la prochaine réservation APRÈS la fin de la fenêtre.
--
-- Exemple avec temps_attente = 30 minutes :
...
--
-- Aucun ALTER TABLE requis. Les changements sont purement côté Java
-- (GroupingService.java et PlanificationController.java).
-- ================================================================
...
-- ============================
-- Réservations de test Sprint 5
-- Test de la fenêtre glissante avec temps_attente = 30 minutes
-- ============================
-- Résultat attendu :
--   Fenêtre 1 : [08:00, 08:30] -> resa 1 (08:00) + resa 2 (08:18)
--   Fenêtre 2 : [08:40, 09:10] -> resa 3 (08:40) + resa 4 (09:00)

INSERT INTO reservation (client_id, nombre_passager, date_arrivee, hotel_id, aeroport_id) VALUES
('CLIENT-001', 2, '2026-03-12 08:00:00', 1, 1),  -- resa 1 : 08:00 -> Ocean View Hotel
('CLIENT-002', 3, '2026-03-12 08:18:00', 2, 1),  -- resa 2 : 08:18 -> Capital Lodge
('CLIENT-003', 2, '2026-03-12 08:40:00', 3, 1),  -- resa 3 : 08:40 -> Palm Resort
('CLIENT-004', 1, '2026-03-12 09:00:00', 4, 1);  -- resa 4 : 09:00 -> Highland Inn
